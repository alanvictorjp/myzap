...
app.post("/startTyping", async function startTyping(req, res, next) {
    var result = await Sessions.startTyping(req);
    res.json(result);
});//startTyping


app.post("/stopTyping", async function stopTyping(req, res, next) {
    var result = await Sessions.stopTyping(req);
    res.json(result);
});//stopTyping
...
app.get("/getAllMessagesInChat", async (req, res, next) => {
...
app.get("/getMessages", async (req, res, next) => {
    var result = await Sessions.getMessages(
		req.body.sessionName,
		req.body.number
		);
    res.json(result);
...
app.get("/getHostDevice", async (req, res, next) => {
    var result = await Sessions.getHostDevice(req.body.sessionName);
    res.json(result);
}); //getHostDevice

app.get("/getBatteryLevel", async (req, res, next) => {
    var result = await Sessions.getBatteryLevel(req.body.sessionName);
    res.json(result);
}); //getBatteryLevel

app.get("/getAllNewMessages", async (req, res, next) => {
    var result = await Sessions.getAllNewMessages(req.body.sessionName);
    res.json(result);
}); //getAllChatsNewMsg
